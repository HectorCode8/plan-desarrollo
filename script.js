document.addEventListener('DOMContentLoaded', () => {
            ...
            const proposals = {
                eje1: [
                    { id: 'movilidad_inteligente', title: '🚌 Movilidad para Todos', desc: '4 autobuses nuevos conectando cabecera y comunidades con rutas fijas, horarios definidos y app de seguimiento.', counter: 4, details: '<strong>Beneficio:</strong> Puntualidad y certeza para tus traslados. Se crearán rutas estratégicas para San José de la Tinaja, Citala, La Puerta y más, asegurando un transporte público eficiente, seguro e inclusivo.<div class="mt-2 text-left text-xs bg-slate-100 p-2 rounded-lg"><p class="font-bold">Ej. Ruta Citala - Teocuitatlán:</p><p>L-V: 6:30 AM, 9:00 AM, 3:30 PM, 6:00 PM</p></div>' },
