document.addEventListener('DOMContentLoaded', () => {
            ...
            function createChart(canvas) {
                ...
                switch (type) {
                    ...
                    case 'despacho_itinerante_chart': config = { type: 'doughnut', data: { labels: ['Comunidades Atendidas', 'Pendientes'], datasets: [{ data: [100, 0], backgroundColor: ['#14b8a6', '#e5e7eb'], borderColor: ['#fff'], borderWidth: 4 }] }, options: { ...defaultOptions, cutout: '70%', plugins: { ...defaultOptions.plugins, title: { ...chartTitleOptions, text: 'Meta: 100% comunidades visitadas al mes' } } } }; break;
